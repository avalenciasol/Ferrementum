...
const Cart = () => {
  ...
  const [cartItems, setCartItems] = useState([
    ...
    {
      id: 2,
      producto: 'Pintura Interiores - Blanca 5Gl',
      marca: 'KÖLOR',
      precio: 224.925,
      cant: 1,
      imagen: "../../assets/images/products/pintura.png"
    },
    {
      id: 3,
      producto: "Porta Herramientas",
      marca: "STANLEY",
      precio: 58.900,
      cant: 1,
      imagen: "../../assets/images/products/portaHerramientas.png"
    }
  ])
              ...
              {cartItems.map((item) => (
                <div className='cart-item'>
                  ...
                  <div className='item-details'>
                    <h4>{item.producto}</h4>
                    <p>{(item.precio ? (item.precio * item.cant).toFixed(3) : '0')} COP</p>
